		...
		try {
			if (action != null) {
				...
				case "getCustomizationDetails":
					...
					break;
				case "getSpacesDetails":
					cuUserManagementGetService.getSpaceDetails(req, resp);
					break;
				case "getPluginDetails":
					cuUserManagementGetService.getPluginDetails(req,resp);
					break;
				case "getpolarionLicenseDetails":
					cuUserManagementGetService.getpolarionLicenseDetails(req, resp);
				default:
